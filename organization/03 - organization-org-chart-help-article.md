...
3. Enter a role name and add its responsibilities.
4. Optionally add a description.
5. Assign a user to the role.
6. Set a parent role to place it correctly in the hierarchy.
7. Click **Save**.
...
- Any team member can add, edit, or delete Org Chart roles — these actions are not restricted by permission level.
