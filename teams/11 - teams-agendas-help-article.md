...
3. Enter a name for the Agenda when prompted.
4. You'll be sent to the Agenda creation menu, which contains a description field and the list of Agenda steps.
5. The new Agenda starts blank — add steps one at a time to build out the meeting flow.
6. Save the Agenda when you're done.
