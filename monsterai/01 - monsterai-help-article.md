...
- **Ask about features by name.** If you're trying to use the Tangent popup or the Conclude step, mention it directly so MonsterAI can point you to the right guidance.
- **Use it during setup.** When configuring an Agenda, building your Org Chart, or defining Objectives, ask MonsterAI for tips before you start.
